...
import 'package:x_amap_base/src/utils/compatibility/color_extensions.dart';

import 'types.dart';

/// Uniquely identifies a [Polyline] among [AMap] polylines.
///
/// This does not have to be globally unique, only unique among the list.
@immutable
class PolylineId extends MapsObjectId<Polyline> {
  /// Creates an immutable object representing a [PolylineId] among [AMap] polylines.
  ///
